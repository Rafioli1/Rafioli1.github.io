...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var colourScheme = readData("colourScheme");
        var where = readData("where");
        var frequency = readData("frequency");
        var recommend = readData("recommend");
        var comments = readData("comments");
        
        res.render('showResults', {results: [name, colourScheme, where, frequency, recommend, comments]});
        console.log([name, colourScheme, where, frequency, recommend, comments]);
    });
